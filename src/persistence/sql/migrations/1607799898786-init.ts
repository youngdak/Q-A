...
export class init1607799898786 implements MigrationInterface {
    name = 'init1607799898786'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Token" ("id" character varying NOT NULL, "token" character varying NOT NULL, "device" character varying NOT NULL, "refreshToken" character varying NOT NULL, "userId" character varying NOT NULL, CONSTRAINT "PK_206d2a22c0a6839d849fb7016b5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Tag" ("id" character varying NOT NULL, "name" character varying NOT NULL, "userId" character varying NOT NULL, CONSTRAINT "PK_00bd1ec314f664289873394731a" PRIMARY KEY ("id"))`);
